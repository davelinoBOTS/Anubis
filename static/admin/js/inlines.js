    ...
    $.fn.formset = function(opts) {
        ...
        const addInlineDeleteButton = function(row) {
            if (row.is("tr")) {
                ...
                row.children(":last").append('<div><a class="btn btn-outline-primary btn-block ' + options.deleteCssClass + '" href="#">' + options.deleteText + "</a></div>");
            } else if (row.is("ul") || row.is("ol")) {
                // If they're laid out as an ordered/unordered list,
                // insert an <li> after the last list item:
                row.append('<li><a class="btn btn-outline-primary btn-block ' + options.deleteCssClass + '" href="#">' + options.deleteText + "</a></li>");
            } else {
                // Otherwise, just insert the remove button as the
                // last child element of the form's container:
                row.children(":first").append('<span><a class="btn btn-outline-primary btn-block ' + options.deleteCssClass + '" href="#" style="width: 100px;float: right;margin-top:-7px;">' + options.deleteText + "</a></span>");
            }
    ...
    $(document).ready(function() {
        $(".js-inline-admin-formset").each(function() {
            ...
            case "stacked":
                ...
                break;
            case "tabular":
                selector = inlineOptions.name + "-group .tabular.inline-related tbody:first > tr.form-row-web";
